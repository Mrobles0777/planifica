...
const Layout: React.FC<LayoutProps> = ({ user, view, setView, handleLogout, errorMessage, setErrorMessage, children }) => {
  ...
  return (
    <div className="min-h-screen bg-[#fffdf5] flex flex-col items-center">
      ...
      <div className="w-full sm:max-w-[640px] md:max-w-[900px] lg:max-w-[1200px] bg-white shadow-2xl min-h-screen flex flex-col relative overflow-hidden">
        ...
        {/* Bottom Navigation */}
        <nav className="bg-white/90 backdrop-blur-md border-t-2 border-yellow-100 px-8 py-6 fixed bottom-0 left-0 right-0 sm:max-w-[640px] md:max-w-[900px] lg:max-w-[1200px] mx-auto z-40 flex items-center justify-around no-print shadow-[0_-10px_40px_rgba(0,0,0,0.05)] md:rounded-t-3xl">
          <button
